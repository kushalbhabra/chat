 ...
 */
export function createMessageHandlers(adapter) {
    return {
        /**
         ...
         */
        onThreadReplyAdded: async (activity) => {
            const message = activityToMessage(activity);
         ...
         */
        onReactionAdded: async (activity) => {
         ...
         */
        onReactionRemoved: async (activity) => {
